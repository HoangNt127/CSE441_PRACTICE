...
public class CallPhoneActivity extends AppCompatActivity {
    ...
    Button btnback1; @Override

    protected void onCreate(Bundle savedInstanceState) { super.onCreate(savedInstanceState); setContentView(R.layout.call_layout);
        edtcall = (EditText) findViewById(R.id.edtcall);
        btnback1 = (Button) findViewById(R.id.btnback1); btncallphone = (ImageButton) findViewById(R.id.btncallphone); btncallphone.setOnClickListener(new View.OnClickListener() {
            @Override
